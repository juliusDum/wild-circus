 ...
 */
final class Version20200723175320 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_542FBD76A76ED395 ON order_ticket');
        $this->addSql('ALTER TABLE order_ticket DROP user_id');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE order_ticket ADD user_id INT NOT NULL');
        $this->addSql('ALTER TABLE order_ticket ADD CONSTRAINT FK_542FBD76A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_542FBD76A76ED395 ON order_ticket (user_id)');
    }
}
